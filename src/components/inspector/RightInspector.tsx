...
export const RightInspector: React.FC<RightInspectorProps> = ({
  ...
  if (!selectedNode && !selectedCharacter && !selectedLocation) {
    return (
      <div className="w-80 bg-surface border-l border-outline/25 flex flex-col h-full z-20 select-none transition-colors duration-200">
        <div className="flex items-center justify-between px-4 py-3 border-b border-outline/25 bg-variant/40">
        ...
        <div className="p-5 flex flex-col items-center justify-center text-center text-muted my-auto space-y-3">
          <div className="p-3 bg-cell rounded-xl border border-outline/25">
          ...
          <div className="w-full pt-4 border-t border-outline/25 text-left space-y-2 text-xs text-muted">
            ...
            <div className="flex justify-between">
              <span>Locations:</span>
              <span className="font-mono text-text">{project.locations.length}</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="p-4 space-y-4 overflow-y-auto flex-1 text-xs">
          <div>
            ...
            <input
              ...
              className="w-full bg-cell border border-outline/25 rounded-lg px-3 py-2 text-text focus:outline-none focus:border-primary"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full bg-cell border border-outline/25 rounded-lg px-3 py-2 text-text focus:outline-none focus:border-primary resize-none"
            />
          </div>
        </div>
      </div>
        ...
        <div className="p-4 space-y-4 overflow-y-auto flex-1 text-xs">
          <div>
            ...
            <input
              ...
              className="w-full bg-cell border border-outline/25 rounded-lg px-3 py-2 text-text focus:outline-none focus:border-secondary"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full bg-cell border border-outline/25 rounded-lg px-3 py-2 text-text focus:outline-none focus:border-secondary resize-none"
            />
          </div>
        </div>
      </div>
  ...
  const handleDuplicate = () => {
    onAddNode(selectedNode.type as NodeType, {
  ...
  return (
    <div className="w-80 bg-surface border-l border-outline/25 flex flex-col h-full z-20 select-none transition-colors duration-200">
      ...
      <div className="p-4 space-y-4 overflow-y-auto flex-1 text-xs">
        {/* Start Node Control */}
        <div className="p-3 bg-cell rounded-xl border border-outline/25 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <Flag
          ...
          <>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-cell border border-outline/25 rounded-lg px-3 py-2 text-text focus:outline-none focus:border-primary resize-none font-sans"
              />
            </div>
          </>
        )}
        ...
        {selectedNode.type === 'narration' && (
          <div>
            ...
            <textarea
              ...
              className="w-full bg-cell border border-outline/25 rounded-lg px-3 py-2 text-text focus:outline-none focus:border-complete resize-none font-sans"
            />
          </div>
        )}
        ...
        {selectedNode.type === 'action' && (
          <div>
            ...
            <textarea
              ...
              className="w-full bg-cell border border-outline/25 rounded-lg px-3 py-2 text-text focus:outline-none focus:border-called resize-none font-sans"
            />
          </div>
        )}
          ...
          <>
            <div>
              ...
              <input
                ...
                className="w-full bg-cell border border-outline/25 rounded-lg px-3 py-2 text-text focus:outline-none focus:border-secondary font-sans"
              />
            </div>
            ...
            <div className="space-y-2 pt-2">
              ...
              <div className="space-y-2">
                {((selectedNode.data as ChoiceNodeData).choices || []).map((choice, idx) => (
                  <div
                    key={choice.id}
                    className="flex items-center gap-2 p-2 bg-cell border border-outline/25 rounded-lg"
                  >
        ...
        {/* Node Meta Info */}
        <div className="pt-4 border-t border-outline/25 text-[11px] text-muted space-y-1 font-mono">
        ...
        <div className="pt-3 border-t border-outline/25 grid grid-cols-2 gap-2">
          <button
            onClick={handleDuplicate}
            className="flex items-center justify-center gap-1.5 py-2 bg-cell hover:bg-variant border border-outline/25 text-text rounded-lg text-xs font-semibold transition-all"
          >
            <Copy className="w-3.5 h-3.5 text-primary" /> Duplicate
          </button>
          <button
            onClick={() => onDeleteNode(selectedNode.id)}
            className="flex items-center justify-center gap-1.5 py-2 bg-called/15 hover:bg-called/30 border border-called/40 text-called rounded-lg text-xs font-semibold transition-all"
          >
